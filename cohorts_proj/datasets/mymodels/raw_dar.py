...
class RawDAR(models.Model):
    ...
    sample_gestage_days = models.FloatField(blank = True, null=True, default = -9.0)

    # Outcome – categorical variable: 1 = preterm birth; 0 = term
    preterm = models.CharField(max_length=100, choices=CAT_DAR_OUTCOME, null = True, blank=True, default = '-9')
    ...
    iAs_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    AsB_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    AsIII_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    AsV_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    DMA_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    MMA_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Ba_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Cs_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    W_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Ag_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Al_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    As_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Be_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Ca_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Cd_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Co_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Cr_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Cu_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Fe_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Hg_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    K_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Mg_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Mn_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Mo_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Ni_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    P_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Pb_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Sb_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Se_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Si_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Sn_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Sr_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Tl_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    U_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    Zn_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
    ...
    V_BDL = models.CharField(max_length=100, choices=CAT_DAR_BDL, default = -9.0, null=True)
